  ...
  return (
    <main className="mx-auto max-w-2xl space-y-4 px-4 py-5">
      ...
      <div className="flex items-center justify-between gap-3 print:hidden">
        <Link href={`/f/${encodeURIComponent(token)}`} className="text-sm font-medium text-zinc-500 hover:text-zinc-700">
          ← Πίσω στο έργο
        </Link>
        <button
          type="button"
      ...
      <div className="space-y-5 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-zinc-100">
