...
function buildBriefPrompt(
  ...
  return [
    ...
    'Βασίσου ΑΠΟΚΛΕΙΣΤΙΚΑ στη μεταγραφή κλήσης παρακάτω. Μην επινοείς τίποτα που δεν λέγεται.',
    ...speakerGuidance,
    'Γράψε ΑΝΑΛΥΤΙΚΟ αλλά καθαρό CRM brief στα ελληνικά, με ΑΚΡΙΒΩΣ την παρακάτω δομή και τίτλους ενοτήτων:',
    '',
    '1) Ξεκίνα με «AI brief από ηχογράφηση:» και αμέσως μετά μια Σύνοψη 2-4 προτάσεων: τι αφορούσε η κλήση, το αίτημα/πρόβλημα του πελάτη και το βασικό αποτέλεσμα ή συμφωνία.',
    '',
