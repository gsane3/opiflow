...
function buildBriefPrompt(
  ...
  return [
    ...
    'Η μεταγραφή παρακάτω περιέχει πραγματικό λόγο από κλήση. Φτίαξε ΠΑΝΤΑ μια περίληψη με βάση όσα ειπώθηκαν — ΑΚΟΜΗ κι αν μιλάει κυρίως ο ένας, αν δεν διακρίνονται οι ομιλητές, ή αν φαίνεται ότι καταγράφηκε κυρίως η μία πλευρά (σε αυτή την περίπτωση σύνοψέ ό,τι ακούστηκε και, αν χρειάζεται, σημείωσε σύντομα ότι η μία πλευρά ίσως δεν καταγράφηκε καθαρά). ΠΟΤΕ μην αρνηθείς και μην γράψεις «Χωρίς συνομιλία» — υπάρχει περιεχόμενο να συνοψίσεις.',
    ...speakerGuidance,
    'Γράψε ΑΝΑΛΥΤΙΚΟ αλλά καθαρό CRM brief στα ελληνικά, με ΑΚΡΙΒΩΣ την παρακάτω δομή και τίτλους ενοτήτων:',
    '',
